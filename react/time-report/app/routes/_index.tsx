...
export const meta: V2_MetaFunction = () => [{ title: "Time reporting" }];
          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            <div className="absolute inset-0">
              <img
                ...
                src="/_static/clock.jpg"
                alt="Time report clock"
              />
              <div className="absolute inset-0 bg-[color:rgba(255,255,255,0.5)] mix-blend-multiply" />
            </div>
